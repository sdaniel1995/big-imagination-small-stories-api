pipeline {
    ...
    stages {
       ...
       stage('Build Docker Image') {
           steps {
               sh 'docker build -t danielshane861/big-imagination-small-stories-api:latest_api .'
           }
       }
       ...
       stage('Push Docker Image') {
           steps {
               ...
               sh 'docker push danielshane861/big-imagination-small-stories-api:latest_api'
           }
       }
